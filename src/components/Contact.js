...
import contactImg from "../assets/img/blessinho.png";
import 'animate.css';
...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.code === 200) {
      ...
      setStatus({ succes: false, message: 'Alguma coisa deu errado, por favor tente novamente mais tarde.'});
    }
  };
      ...
      <Container>
        <Row className="align-items-center">
          <Col size={12} md={6}>
            <TrackVisibility>
              {({ isVisible }) =>
                <img id="blessinho-contact" className={isVisible ? "animate__animated animate__zoomIn" : ""} src={contactImg} alt="Contact Us"/>
              }
            </TrackVisibility>
          </Col>
          <Col size={12} md={6}>
              ...
              {({ isVisible }) =>
                ...
                <form onSubmit={handleSubmit}>
                  <Row>
                    ...
                    <Col size={12} sm={6} className="px-1">
                      <input type="tel" value={formDetails.phone} placeholder="Num. Telefone" onChange={(e) => onFormUpdate('phone', e.target.value)}/>
                    </Col>
